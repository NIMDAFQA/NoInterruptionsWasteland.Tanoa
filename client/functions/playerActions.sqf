...
[
	...
	[format ["<img image='\a3\Ui_f\data\GUI\Cfg\CommunicationMenu\supplydrop_ca.paa' color='%1'/> <t color='%1'>[</t>Airdrop Menu<t color='%1'>]</t>", "#FF0000"],"addons\APOC_Airdrop_Assistance\APOC_cli_menu.sqf",[], -99, false, false, "","vehicle player == player"],				//airdrops
	[format ["<img image='\a3\Ui_f\data\GUI\Cfg\CommunicationMenu\cas_ca.paa' color='%1'/> <t color='%1'>[</t>Airstrikes Menu<t color='%1'>]</t>", "#FF0000"], "addons\airstrikes\airstrikes_cli_menu.sqf", [], -99, false, false, "","vehicle player == player"],				//airstrikes
	[format ["<img image='\a3\Ui_f\data\GUI\Cfg\CommunicationMenu\instructor_ca.paa' color='%1'/> <t color='%1'>[</t><t color='%2'>ALLAHU AKBAR</t><t color='%1'>]</t>", "#D60606", "#000000"], { playSound "allahu_akbar"; sleep 2; _kek = "Bomb_04_F" createVehicle (position player); removeVest player;}, [], -101, false, false, "","vest player == 'V_Press_F'"],			//allahu akbar
